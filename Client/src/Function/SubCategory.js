...
const createSubCategory =async (name,parentID) =>{
  try {
    const createSub = await axios.post("/sub",name,parentID)
...
const allSubCategory =async () =>{
  try {
    const allSub = await axios.get("/sub")
...
const singleSubCategory =async (slug) =>{
  try {
    const single = await axios.get(`/sub/${slug}`)
...
const updateSubCategory =async (slug) =>{
  try {
    const updateSub = await axios.put(`/sub/${slug}`)
...
const removeSubCategory =async (slug) =>{
  try {
    const remove = await axios.delete(`/sub/${slug}`)
